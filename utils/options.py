...
def args_parser():
    ...
    parser.add_argument('--mu', type=float, default=1, help="fedprox parameter")
    ...
    # model arguments
    parser.add_argument('--optimizer', type=str, default='fedprox', help='optimizer: fedavg, fedprox')
    parser.add_argument('--model', type=str, default='Mnist_oldMLP', help='model name: mlp, cnn, vgg, Mnist_oldMLP,synth_Net') #
    ...
    parser.add_argument('--iid', type=str, default='iid', help='iid, niid, dirichlet')
    ...
    parser.add_argument('--selection', type = str,default='uni_random', #uni_random, solve_opti_loss_size,solve_opti_loss_size2,solve_opti_size, solve_opti_loss, weighted_random, best_loss,  best_channel,best_channel_ratio, salehi, best_datasize_success_rate
                        help='user selection strategy')
    parser.add_argument('--opti', default='LR', type = str,
                        help='optimization method to solve power allocation (and user selection): WR, P1, P2,P4')
    ...
    parser.add_argument('--test_method',
                        default='normal', #uni_weights, exact_loss, sum_loss
                        type = str,
                        help='optimization method')
    parser.add_argument('--curvy',
                        default= 3, #uni_weights, exact_loss, sum_loss
                        type = float,
                        help='optimization method')
    parser.add_argument('--eta_init',
                        default= 4, #uni_weights, exact_loss, sum_loss
                        type = float,
                        help='optimization method')
    ...
    parser.add_argument('--weight_normalization',
                        default='none', # mean, median, none, max
                        type = str,
                        help='optimization method')
